                                        ...
                                        VStack {
                                            ...
                                            HStack {
                                                Text("  Protocol: ")
                                                    .font(Font.headline.bold())
                                                    .foregroundColor(.black)
                                                Text(model.isNewProtocol ? "New" : "Old")
                                                Spacer()
                                            }
                                            HStack {
                                                Text("  Serial number: ")
...
struct OtherParametres: View {

    // MARK: Observable objects

    @ObservedObject var model: Model
    @State private var showPPS = false
    ...
    @State private var showIMU = false
    @State private var showIMUAcc = false
    @State private var showIMURotation = false
    @State private var showIMURotationRaw = false
    @State private var showIMUMagneticRaw = false
    @State private var showIMUTemp = false
