                                    ...
                                    HStack {
                                        SelectButton(
                                            ...
                                            if model.isBottomLaser {
                                                ...
                                                model.currentOffsetsString = "With laset: iPhone14ProMaxBack"
                                                model.currentOffsets = AntennaOffset.Laser.iPhone14ProMaxBack
                                                model.useLaser = true
                                    ...
                                    VStack {
                                        ...
                                        HStack {
                                            ...
                                            SelectButton(
                                                ...
                                                model.currentOffsetsString = "Without laset: iPhone14ProMaxBottom"
                                                model.currentOffsets = AntennaOffset.Camera.iPhone14ProMaxBottom
                                ...
                                VStack {
                                    ...
                                    if showNavdop {
                                        VStack {
                                            ...
                                            HStack {
                                                Button("Enabled", action: { model.changeStatusNAVDOP(activate: true)}).buttonStyle(.bordered)
                                                Button("Disabled", action: { model.changeStatusNAVDOP(activate: false)}).buttonStyle(.bordered)
                                            }
                                            Text("NAVPVT").font(Font.headline.bold())
                                            HStack {
                                                Button("Enabled", action: { model.changeStatusNAVPVT(activate: true)}).buttonStyle(.bordered)
                                                Button("Disabled", action: { model.changeStatusNAVPVT(activate: false)}).buttonStyle(.bordered)
                                            }
                                        }
                                    }
                                }
                                        ...
                                        VStack {
                                            ...
                                            VStack {
                                                ...
                                                HStack {
                                                    ...
                                                    Button("Enabled", action: { model.changeStatusGNSS(satellite: .glonass, activate: true)}).buttonStyle(.bordered)
                                                    Button("Disabled", action: { model.changeStatusGNSS(satellite: .glonass, activate: false)}).buttonStyle(.bordered)
                                                }
                                                HStack {
                                                    Button("Status BeiDou",action: { model.getCurrentStatusGNSS(satellite: .beidou)}).buttonStyle(.bordered)
                                                    Button("Enabled", action: { model.changeStatusGNSS(satellite: .beidou, activate: true)}).buttonStyle(.bordered)
                                                    Button("Disabled", action: { model.changeStatusGNSS(satellite: .beidou, activate: false)}).buttonStyle(.bordered)
                                                }
                                                HStack {
                                                    Button("Status Galileo",action: { model.getCurrentStatusGNSS(satellite: .galileo)}).buttonStyle(.bordered)
                                                    Button("Enabled", action: { model.changeStatusGNSS(satellite: .galileo, activate: true)}).buttonStyle(.bordered)
                                                    Button("Disabled", action: { model.changeStatusGNSS(satellite: .galileo, activate: false)}).buttonStyle(.bordered)
                                                }
                                                HStack {
                                                    Button("Status QZSS",action: { model.getCurrentStatusGNSS(satellite: .qzss)}).buttonStyle(.bordered)
                                                    Button("Enabled", action: { model.changeStatusGNSS(satellite: .qzss, activate: true)}).buttonStyle(.bordered)
                                                    Button("Disabled", action: { model.changeStatusGNSS(satellite: .qzss, activate: false)}).buttonStyle(.bordered)
                                                }
                                                HStack {
                                                    Button("Status SBAS",action: { model.getCurrentStatusGNSS(satellite: .sbas)}).buttonStyle(.bordered)
                                                    Button("Enabled", action: { model.changeStatusGNSS(satellite: .sbas, activate: true)}).buttonStyle(.bordered)
                                                    Button("Disabled", action: { model.changeStatusGNSS(satellite: .sbas, activate: false)}).buttonStyle(.bordered)
                                                }
